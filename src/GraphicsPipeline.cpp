    ...
    swapchain(swapchain)
{
    ...
    result = vkCreateDescriptorSetLayout(vkInstance->getVulkanLogicalDevice(), &layoutInfo, nullptr, &descriptorSetLayout);
    if (result != VK_SUCCESS) {
        std::cerr << string_VkResult(result) << std::endl;
    ...
    result = vkCreatePipelineLayout(vkInstance->getVulkanLogicalDevice(), &pipelineLayoutInfo, nullptr, &pipelineLayout);
    if (result != VK_SUCCESS) {
        std::cerr << string_VkResult(result) << std::endl;
